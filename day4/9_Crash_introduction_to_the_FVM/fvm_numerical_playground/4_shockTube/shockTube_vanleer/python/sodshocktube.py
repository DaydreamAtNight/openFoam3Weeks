...
cols = [np.loadtxt('../postProcessing/sampleDict/0.1_Euler_linear/data_T_mag(U)_p.xy'),
        ...
        np.loadtxt('../postProcessing/sampleDict/0.1_Euler_QUICK/data_T_mag(U)_p.xy'),
        np.loadtxt('../postProcessing/sampleDict/0.1_Euler_SuperBee_more_iterations/data_T_mag(U)_p.xy'),
        np.loadtxt('../postProcessing/sampleDict/0.1_Euler_Minmod/data_T_mag(U)_p.xy'),
        ]
        
labels = ['linear', 'upwind', 'linearUpwind', 'vanLeer', 'QUICK', 'SuperBee_more_iters']
colors = ['g', 'r', 'c', 'm', 'y', 'k']
titles = 'Solution to the Sod Shock Problem at time = 0.1s, Euler in time'


# print(list(pos_array))
# print(list(vel_array))
# print(list(cols[0][:,0]))
# print(list(cols[0][:,2]))
# print(list(cols[1][:,2]))
# print(list(cols[2][:,2]))
...
plt.xlim([0.46,0.55])
plt.ylim([0.25,0.42])
plt.title('zoom upwind expansion')
plt.savefig('pre_up_zoom.png', dpi=100)


#velocity magnitude plot
def velocity_magnitude_plot():    
...
plt.xlim([0.64,0.68])
plt.ylim([0.7,0.95])
plt.title('zoom shock upwind')
plt.savefig('vel_mag_up_shock_zoom.png', dpi=100)

plt.xlim([0.67,0.7])
plt.ylim([-0.01,0.12])
plt.title('zoom shock downwind')
plt.savefig('vel_mag_down_shock_zoom.png', dpi=100)

plt.xlim([0.46,0.55])
plt.ylim([0.75,1.0])
plt.title('zoom expansion upwind')
plt.savefig('vel_mag_up_expansion_zoom.png', dpi=100)

plt.xlim([0.35,0.4])
plt.ylim([-0.01,0.12])
plt.title('zoom expansion downwind')
plt.savefig('vel_mag_down_expansion_zoom.png', dpi=100)
